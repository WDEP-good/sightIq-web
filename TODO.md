...
[
    {
        "province": "xxx", // 省份名称
        "total_visitors": 123456, // 省内游客总量
        "scenic_spots": [ // 各景区详情
            {
                "name": "xxx", // 景区名称
                "visitor_count": 1234 // 游客数量
            }
        ],
        "date": "2024-01-01 12:00:00" // 数据时间
    }
]
```
...
[
    {
        ...
        "regions": [
            {
                "region_name": "xxx", // 地区名称
                "heat_value": 0.85, // 热度值
                "visitor_density": 0.75 // 游客密度
            }
        ],
        "date": "2024-01-01 12:00:00" // 数据时间
    }
...
[
    {
        "province": "xxx", // 省份名称
        "season": "春季",
        "popular_spots": [ // 当季热门景区
            {
                "name": "xxx", // 景区名称
                "popularity_score": 0.92, // 热度评分
                "featured_attractions": ["樱花", "踏青"] // 特色吸引物
            }
        ],
        "date": "2024-Q1" // 季度
    }
