...
// @ts-ignore
import jiangxijson from "@/assets/jiangxi.json";

let myChart: echarts.ECharts | null = null;
var index = 0; //播放所在下标

echarts.registerMap("江西", jiangxijson as any);

onMounted(() => {
  myChart = echarts.init(document.getElementById("chartJiangXi"));
  myChart.showLoading();
