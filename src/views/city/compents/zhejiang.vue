...
// @ts-ignore
import zhejiangjson from "@/assets/zhejiang.json";

let myChart: echarts.ECharts | null = null;
var index = 0; //播放所在下标

echarts.registerMap("浙江", zhejiangjson as any);

onMounted(() => {
  myChart = echarts.init(document.getElementById("chartZheJiang"));
  myChart.showLoading();
